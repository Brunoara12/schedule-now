...
public class SchedulingTest{
	...
	public void beforeTest() {
		...
		//wait.until(ExpectedConditions.presenceOfElementLocated(By.id("job-id")));
	}
	...
	public void givenSchedulingPage_whenInvalidEmail_thenInputValidator() {
		clear();
		assertTrue(driver.findElement(By.className("ng-valid-email")).isDisplayed(), "Email input should be valid at this point");
		...
		assertTrue(driver.findElement(By.className("ng-invalid-email")).isDisplayed(), "Email input should be invalid at this point");
